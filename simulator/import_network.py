...
class Simulation:
    ...
    def network_init(self):
        ...
        self.theta = 0.1
        self.q_alpha = para.q_alpha
        self.q_gamma = para.q_gamma
    ...
    def run_simulator(self, run_times, E_mc, output_filename):
        ...
        for nb_run in range(run_times):
            ...
            life, nb_dead = net.simulate(optimizer=q_learning, t=0, dead_time=0)
        ...
        result.writerow({"nb_run": np.mean(life_time), "lifetime": h, "dead_node": 0,  "elapsed_time": elapsed_time})
